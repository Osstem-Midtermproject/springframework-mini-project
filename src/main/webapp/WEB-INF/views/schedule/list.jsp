          ...
          <div class="card-body align-items-center vw-90" >
            ...
            <div class="bg-light"  id="select" style=" margin-bottom: 1rem; padding: 0.8rem; ">
              ...
              <div class="d-flex text-center mb-2">
                ...
                <input type="checkbox" id="categoryCheckbox1"  name="categoryCheckbox" checked>
                <label class="" for="categoryCheckbox1">상담</label>
                </div>
                <div class="" style="padding-right: 2rem;">
                    <input type="checkbox" id="categoryCheckbox2"  name="categoryCheckbox" checked>
                    <label class="" for="categoryCheckbox2">AS</label>
                </div>
                <div class="" style="padding-right: 2rem;">
                    <input type="checkbox" id="categoryCheckbox3"  name="categoryCheckbox" checked>
              ...
              <div class="d-flex text-center mb-2">
                ...
                <div class="" style="padding-right: 2rem;">
                  <input type="checkbox" id="periodCheckbox5" onclick="onClickCheckbox(this)" name="periodCheckbox" checked>
                  <label class="" for="periodCheckbox5">전체</label>
                </div>
                <div class="" style="padding-right: 2rem; ">
                <input type="checkbox" id="periodCheckbox1" onclick="onClickCheckbox(this)" name="periodCheckbox">
                <label class="" for="periodCheckbox1">1일</label>
                </div>
                <div class="" style="padding-right: 2rem;">
                    <input type="checkbox" id="periodCheckbox2" onclick="onClickCheckbox(this)" name="periodCheckbox">
                    <label class="" for="periodCheckbox2">7일</label>
                </div>
                <div class="" style="padding-right: 2rem;">
                    <input type="checkbox" id="periodCheckbox3" onclick="onClickCheckbox(this)" name="periodCheckbox">
                    <label class="" for="periodCheckbox3">1달</label>
                </div>
                <div class="" style="padding-right: 2rem;">
                  <input type="checkbox" id="periodCheckbox4" onclick="onClickCheckbox(this)" name="periodCheckbox">
                  <label class="" for="periodCheckbox4">3달</label>
                </div>
              </div>
              ...
              <div class="d-flex text-center mb-2">
                ...
                <div class="" style="padding-right: 2rem; ">
                <input type="checkbox" id="sortCheckbox1" onclick="onClickSortCheckbox(this)" name="sortCheckbox" checked>
                <label class="" for="sortCheckbox1">최신순(시작일기준)</label>
                </div>
                <div class="" style="padding-right: 2rem;">
                  <input type="checkbox" id="sortCheckbox2" onclick="onClickCheckbox(this)" name="sortCheckbox">
                  <label class="" for="sortCheckbox2">최신순(종료일기준)</label>
                </div>
                <div class="" style="padding-right: 2rem;">
                    <input type="checkbox" id="sortCheckbox3" onclick="onClickCheckbox(this)" name="sortCheckbox">
                    <label class="" for="sortCheckbox3">거래금액순(고가)</label>
                </div>
                <div class="" style="padding-right: 2rem;">
                    <input type="checkbox" id="sortCheckbox4" onclick="onClickCheckbox(this)" name="sortCheckbox">
