			...
			<div class="team">
				...
				<div class="card">
					<div class="card-body justify-content-between row">
						...
						<div class="team-wrapper d-flex col-12">
							<div class="col-2">
								<!-- Team Card -->
								<div class="card border"  onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=1'">
									<div class="card-body d-flex flex-column">
								...
								<!-- Team Card -->
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=2'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
								...
								<!-- Team Card -->
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=3'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
							...
							<div class="col-lg-2.1">
								...
								<!-- Team Card -->
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=7'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
								...
								<!-- Team Card -->
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=8'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
								...
								<!-- Team Card -->
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=9'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
							...
							<div class="col-lg-2.1">
								...
								<!-- Team Card -->
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=10'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
								...
								<!-- Team Card -->
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=11'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
								...
								<!-- Team Card -->
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=12'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
							...
							<div class="col-lg-2.1">
								...
								<!-- Team Card -->
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=4'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
								...
								<!-- Team Card -->
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=5'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
								...
								<!-- Team Card -->
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=6'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
							...
							<div class="col-lg-2.1">
								<div class="card border" style="width: 13rem;" onclick="location.href='${pageContext.request.contextPath}/schedule/team/detail?tid=13'">
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center">
