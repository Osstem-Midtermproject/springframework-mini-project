			...
			<div class="card-body" style="padding: 20px 0;">
				<div class="col-xs-3" style="display: flex; flex-flow: row; justify-content: center;">
					<c:forEach items="${topContractList}" var="top" varStatus="status">
						<div class="card" onclick="location.href='${pageContext.request.contextPath}/schedule/processing/detail?hdln=${top.hospital.hdln}'" style="width: 350px; height: 250px; margin-left: 1rem; margin-right: 1rem; margin-bottom: 2rem">
...
<script type="text/javascript">
    ...
    function searchH(no) { 
        ...
        $.each(result.searchContractList,function(index,list){
            ...
            str = str + "<tr onclick = location.href='${pageContext.request.contextPath}/schedule/processing/detail?hdln="+list.hospital.hdln +"'><td>"+list.cno+
