              ...
              <!-- 분기별 디자인 매출액 -->
               <div class="card" OnClick="location.href ='${pageContext.request.contextPath}/analysis/design'" style="cursor:pointer;">
                 <div class="card-body pb-0">
                   <h5 class="card-title">Design <span>| Quarterly</span></h5>
          ...
          <div class="card">
            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">AS/상담 Schedule <span> | Today</span></h5>
             ...
             <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">시공 Schedule <span> | Today</span></h5>
                  <table class="table table-borderless">
                    <thead>
                      <tr>
                        <th scope="col">Category</th>
